		...
		_fn : {
			_prepare_checkboxes : function (obj) {
				...
				obj.each(function () {
					...
					t.find("a").not(":has(.jstree-checkbox)").prepend("<ins class='jstree-checkbox'>&#160;</ins>").parent().not(".jstree-checked, .jstree-unchecked").addClass(c);//添加checkbox
				});
