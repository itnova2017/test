...
<body class="ContentBody">
	<form action="<%=basePath%>userInfo/editUserInfo.action" method="post" >
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
				<tr>
					<th class="tablestyle_title">你当前的位置：系统管理->人员管理->人员修改</th>
				</tr>
				<tr>
					<td class="CPanel">
									...
									<fieldset style="height: 100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
											<tr>
												...
												<td width="35%">
													<input class="text"  type="text"  name="loginName"  id="loginName" style="width: 154px" value="${tui.t_loginName}"  size="50" /> 
												...
												<td width="34%">
													<input class="text"  type="text"  name="userName"  id="userName" style="width: 154px" value="${tui.t_userName}" size="50">
													<span class="red">*</span>
												</td>
											</tr>
											<tr>
												...
												<td>
													<input class="text"  type="password"  name= "password" id="password" style="width: 154px" value="${tui.t_password}" />
													<span class="red">*不填默认为123456</span>
												</td>
												<td align="right">确认密码:</td>
												<td>
													<input class="text"  type="password"  name="password2" id="password2" style="width: 154px" value="${tui.t_password}" />
												</td>
											</tr>
											<tr>
												...
												<c:if test="${not empty listDapt}">
												   <td colspan="3">
														<c:forEach var="dapt"  items="${listDapt}"  varStatus="status">
																<input type="checkbox"  name="dapts"  id="dapts"  value="${dapt.t_id}"  <c:if test="${dapt.isCheck == '1'}"> checked="checked"</c:if>>${dapt.t_departName}&nbsp;&nbsp;&nbsp;&nbsp;													   
